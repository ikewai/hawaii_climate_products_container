...
rf_month_filename<-paste0("hads_daily_rf_TEST_",format((Sys.Date()-1),"%Y_%m"),".csv") #dynamic file name that includes month year so when month is done new file is written
